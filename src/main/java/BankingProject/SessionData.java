...
/*
 * This is used for reading and writing Bank data in json file.
 */
public class SessionData {
    ...
    public void init() {
        ...
        if (data==null || data.length() <= 1) {
            ...
            try {
                this.localData = (gson.fromJson(data, LocalData.class)); //convertin json data into java form
            } catch (Exception e) {
                localData = new LocalData();
            }
        }
    ...
    private String readString() {
        ...
        try{
            FileInputStream fin=new FileInputStream("F:\\BankSystem\\bankData.json");
            int i=0;
            while((i=fin.read())!=-1){
                str.append(""+(char)i);
            }
